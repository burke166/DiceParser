...
/// <summary>Optional explode + optional reroll + optional keep/drop + optional Roll20-style success counting (<c>&gt;=N</c>).</summary>
internal readonly struct DiceRollMods
{
    public readonly ExplodeSpec Explode;
    public readonly RerollSpec Reroll;
    ...
    public DiceRollMods(ExplodeSpec explode, RerollSpec reroll, DiceMod keepDrop, bool hasSuccessCount = false, int successAtLeast = 0)
    {
        Explode = explode;
        Reroll = reroll;
        KeepDrop = keepDrop;
