...
internal sealed class QueueRng : IRng
{
...
public class ExplodeDiceTests
{
    ...
    public void Three_d6_standard_explode_matches_roll20_example()
    {
        ...
        var r = engine.ExecuteWithRng("3d6!", new QueueRng(2, 3, 5, 5, 1)).Single();
    ...
    {
        var engine = new DiceEngine(0);
        var r = engine.ExecuteWithRng("4d6!!", new QueueRng(2, 3, 4, 5, 5, 2)).Single();
    ...
    {
        var engine = new DiceEngine(0);
        var r = engine.ExecuteWithRng("3d6!p", new QueueRng(2, 3, 5, 5, 1)).Single();
    ...
    public void One_d6_compound_penetrating_collapses_chain_using_penetrating_addends()
    {
        ...
        var r = engine.ExecuteWithRng("1d6!!p", new QueueRng(5, 5, 1)).Single();
    ...
    public void Compound_penetrating_accepts_compare_suffix()
    {
        ...
        var r = engine.ExecuteWithRng("1d6!!p>4", new QueueRng(5, 2)).Single();
    ...
    {
        var engine = new DiceEngine(0);
        var r = engine.ExecuteWithRng("3d6!5", new QueueRng(2, 3, 4, 4, 1)).Single();
    ...
    {
        var engine = new DiceEngine(0);
        var r = engine.ExecuteWithRng("3d6!>4", new QueueRng(2, 3, 1, 4, 4, 1)).Single();
    ...
    {
        var engine = new DiceEngine(0);
        var r = engine.ExecuteWithRng("4d6!!>4", new QueueRng(2, 3, 2, 4, 2, 5, 5, 2)).Single();
    ...
    public void One_d6_penetrating_explode_greater_or_equal_4()
    {
        ...
        var r = engine.ExecuteWithRng("1d6!p>4", new QueueRng(3, 4, 1)).Single();
    ...
    public void Plain_dice_and_arithmetic_still_work()
    {
        ...
        var r = engine.Execute("3d10+4").Single();
    ...
    public void Keep_highest_still_works_after_explode_standard_expands_pool()
    {
        ...
        var r = engine.ExecuteWithRng("2d4!kh1", new QueueRng(3, 3, 0, 0)).Single();
    ...
    public void Keep_highest_on_compound_explode_uses_one_slot_per_original_die()
    {
        ...
        var r = engine.ExecuteWithRng("2d10!!kh1", new QueueRng(9, 9, 2, 1)).Single();
    ...
    public void Explode_compare_out_of_range_throws()
    {
        ...
        var ex = Assert.Throws<EvalException>(() =>
            engine.ExecuteWithRng("2d6!7", new QueueRng(0, 0)).Single());
    ...
    public void Custom_die_explode_compare_validated_against_face_min_max()
    {
        var engine = new DiceEngine(0);
        var ex = Assert.Throws<EvalException>(() =>
            engine.ExecuteWithRng("1d{2,4,6,8}!9", new QueueRng(0)).Single());
        Assert.Contains("between", ex.Message, StringComparison.OrdinalIgnoreCase);
    }
    ...
    {
        var engine = new DiceEngine(0);
        var r = engine.ExecuteWithRng("2d{2,4,6,8}!", new QueueRng(3, 1, 0)).Single();
    ...
    public void Explosion_chain_respects_MaxDicePerExpr()
    {
        ...
        var ex = Assert.Throws<EvalException>(() =>
            engine.ExecuteWithRng("1d4!", new QueueRng(3, 3, 3, 3), tight).Single());
